...
Gem::Specification.new do |spec|
  spec.name          = "pig_sniffer"
  spec.version       = PigSniffer::VERSION
  spec.authors       = ["Joshua Monzon"]
  spec.email         = ["Jmonzon0415@gmail.com"]
  ...
  if spec.respond_to?(:metadata)
    ...
    raise "RubyGems 1.0 or newer is required to protect against public gem pushes."
  end
